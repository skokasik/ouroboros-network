...
-- | Setup a network of core nodes, each is both a producer and a consumer
--
...
-- | Run @waitAny@ inside several @withAsyc@s
--
-- An empty list would block indefinitely, which is likely not intended.
