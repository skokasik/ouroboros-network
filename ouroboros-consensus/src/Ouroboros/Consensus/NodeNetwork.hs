...
protocolHandlers NodeArgs {btime, maxClockSkew, tracers, recentTxIdsExpiryThresh, maxUnackTxs, chainSyncPipelining}
                 NodeKernel {getChainDB, getMempool, getNodeConfig, getRecentTxIds} =
